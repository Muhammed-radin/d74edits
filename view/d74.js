const db = {
  ...
  getYTchannelVideos(onfinish, pageTkn = false) {
    ...
    xhr.open('GET', 'https://youtube-v31.p.rapidapi.com/search?channelId=UCFodctpE1wtpFhWw716uCgg&part=snippet%2Cid&order=date&maxResults=13' + (pageTkn == false ? '' : '&pageToken=' + pageTkn));
